...
<template>
  <div class="privacy-container">
    ...
    <section class="privacy-section">
      ...
      <div class="text-definition">
        ...
        <p>
          ...
          ко всей
          информации, которую Оператор может получить о посетителях веб-сайта {{ domain }}.
        </p>
      </div>
    </section>
    ...
    <section class="privacy-section">
      ...
      <div class="text-definition">
        ...
        <p>
          ...
          обеспечивающих их доступность в сети интернет по сетевому адресу {{ domain }}.
        </p>
        <p>
        ...
        <p>
          2.10. Пользователь — любой посетитель веб-сайта {{ domain }}.
        </p>
        <p>
    ...
    <section class="privacy-section">
      ...
      <div class="card">
        <div class="card-item"><strong>Цель обработки:</strong> предоставление доступа Пользователю к сервисам,
                                                                информации и/или материалам, содержащимся на
                                                                веб-сайте
        </div>
        <div class="card-item"><strong>Персональные данные:</strong> фамилия, имя, отчество, электронный адрес</div>
        <div class="card-item"><strong>Правовые основания:</strong> Федеральный закон «Об информации, информационных
                                                                    технологиях и о защите информации» от 27.07.2006 N
                                                                    149-ФЗ
        </div>
        <div class="card-item"><strong>Виды обработки персональных данных:</strong> Сбор, запись, систематизация,
                                                                                    накопление, хранение, уничтожение
                                                                                    и
                                                                                    обезличивание персональных данных,
                                                                                    отправка информационных писем на
    ...
    <section class="privacy-section">
      <h2 class="section-title">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
      <div class="text-definition">
        <p class="note note-info">
        ...
        <p>8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их
           самостоятельно,
           путем направления Оператору уведомление на адрес электронной почты Оператора {{ email }} с пометкой
        ...
        <p class="note note-primary">
          ...
          Оператору
          уведомление посредством электронной почты на электронный адрес Оператора {{ email }} с пометкой «Отзыв
    ...
    <section class="privacy-section">
      <h2 class="section-title">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
      <div class="text-definition">
    ...
    <section class="privacy-section">
      ...
      <div class="text-definition">
        <p>12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его
           персональных
           данных, обратившись к Оператору с помощью электронной почты {{ email }}.</p>
