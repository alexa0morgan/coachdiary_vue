...
<template>
  <section>
    ...
    <AboutSiteCart class="team-img" src="/team_photo.webp">
      Мы — группа студентов, увлеченных идеей создания эффективных решений для тренеров и учителей физкультуры. Веря в
      силу спорта как средства для развития и самосовершенствования, мы решили
      применить наши знания и навыки в программировании для создания Дневник тренера.
    </AboutSiteCart>
    <p class="text">
      В процессе разработки Дневник Тренера, мы не только применили наши академические знания, но и учились на реальных
      задачах и вызовах. Каждый из нас внес уникальный вклад в проект, сочетая в себе разнообразные навыки и интересы
      — от веб-дизайна до программирования и анализа данных. Работая над Дневником Тренера, мы стремились создать
      инструмент,
    ...
    <p class="text">
      ...
      конечном итоге, достижения лучших результатов. Мы верим, что Дневник Тренера может стать мостом между
      традиционными
